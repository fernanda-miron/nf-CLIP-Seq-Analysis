...
- A tool for CLIP-Seq Data Processing
...
Alignment to reference reference_genome
Peak calling
Peak annotation
...
def helpMessage() {
  ...
  ==========================================
	...
	nextflow run ${pipeline_name}.nf --files_path <path to input 1> [--output_dir path to results ]

	  --files_path	<- The path to the reference and fasta files
